...
AC_DEFUN([AX_JM_CHECK_READLINE], [
  READLINE_LIBS=""
  AC_CACHE_CHECK([for a readline compatible library],
                 vl_cv_lib_readline, [
    ORIG_LIBS="$LIBS"
    for readline_lib in s11editline editline readline edit; do
  ...
  if test "$vl_cv_lib_readline" != "no"; then
    ...
    AC_CHECK_HEADERS(s11editline/editline.h editline/editline.h readline.h readline/readline.h)
