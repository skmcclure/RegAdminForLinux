dnl @synopsis AX_JM_COMPILE_CHECK_SIZEOF(TYPE [, HEADERS [, EXTRA_SIZES...]])
dnl
...
dnl      '
dnl
dnl      AX_JM_COMPILE_CHECK_SIZEOF(char)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(short)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(int)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(long)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(unsigned char *)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(void *)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(size_t, $headers)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(ssize_t, $headers)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(ptrdiff_t, $headers)
dnl      AX_JM_COMPILE_CHECK_SIZEOF(off_t, $headers)
dnl
dnl @category Misc
...
AC_DEFUN([AX_JM_COMPILE_CHECK_SIZEOF],[
  changequote(<<, >>)dnl
  ...
  AC_CACHE_VAL(AC_CV_NAME,[
    ...
    for ac_size in 4 8 1 2 16 $2 ; do
      AC_TRY_COMPILE([
#include "confdefs.h"
#include <sys/types.h>
$2
