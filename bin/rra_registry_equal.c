...
main (int argc, const char *argv[])
{
    ...
    poptSetOtherOptionHelp(
        ctxt, "[OPTIONS] <registry dir 1> <registry dir 2>");
    ...
    if (da_arg_count < 2)
    {
        fprintf (
            ...
            "Usage: %s [OPTIONS] <registry dir 1> <registry dir 2>\n",
    ...
    if (!registry_equal(rra_cli_state_get_registry(state1),
                        rra_cli_state_get_registry(state2)))
    {
        exit_val = 1;
    }
